...
function createBrowserHistory(options = {}) {
  function createBrowserLocation(window2, globalHistory) {
    var _a5;
    let maskedLocation = (_a5 = globalHistory.state) == null ? void 0 : _a5.masked;
...
function createBrowserURLImpl(windowImpl, to, isAbsolute = false) {
  ...
  if (windowImpl) base2 = windowImpl.location.origin !== "null" ? windowImpl.location.origin : windowImpl.location.href;
  invariant(base2, "No window.location.(origin|href) available to create URL");
  let href2 = typeof to === "string" ? to : createPath(to);
  href2 = href2.replace(/ $/, "%20");
  if (!isAbsolute && PROTOCOL_RELATIVE_URL_REGEX.test(href2)) href2 = base2 + href2;
...
function flattenRoutes(routes, branches = [], parentsMeta = [], parentPath = "", _hasParentOptionalSegments = false) {
  ...
  routes.forEach((route, index) => {
    var _a5;
    if (route.path === "" || !((_a5 = route.path) == null ? void 0 : _a5.includes("?"))) flattenRoute(route, index);
...
var DataWithResponseInit = class {
  constructor(data2, init) {
    __publicField(this, "type", "DataWithResponseInit");
...
function instrumentHandler(handler, fns) {
  ...
  if (aggregated.request.length > 0) instrumentedHandler = async (...args) => {
    ...
    return throwOrReturnResult(await recurseRight(aggregated.request, {
      ...
      let meta;
      try {
        meta = (_a5 = info.context) == null ? void 0 : _a5.get(instrumentationResultMetaContext);
      } catch {
      }
...
// node_modules/react-router/dist/development/lib/router/matcher.js
var _routes, _branches, _basename, _a2;
var V6RegExMatcher = (_a2 = class {
  constructor(basename) {
    __privateAdd(this, _routes, []);
    __privateAdd(this, _branches, []);
    __privateAdd(this, _basename);
    __privateSet(this, _basename, basename);
  }
  update(routes) {
  ...
  match(locationArg, allowPartial = false) {
    return matchRoutesImpl(__privateGet(this, _routes), locationArg, __privateGet(this, _basename), allowPartial, __privateGet(this, _branches));
  }
}, _routes = new WeakMap(), _branches = new WeakMap(), _basename = new WeakMap(), _a2);

// node_modules/@remix-run/route-pattern/dist/lib/match/punycode.js
var base = 36;
var tMin = 1;
var baseMinusTMin = base - tMin;

// node_modules/react-router/dist/development/lib/router/matcher-route-pattern.preload.js
var RoutePatternMatcher;
...
function createDataRouteMatcher(future, basename) {
  if (future.unstable_routePatternMatching) {
    let RoutePatternMatcher2 = getRoutePatternMatcher();
    invariant(RoutePatternMatcher2, 'You must call unstable_preloadRoutePattern() from "react-router/route-pattern" before enabling future.unstable_routePatternMatching.');
    return new RoutePatternMatcher2(basename);
  }
  return new V6RegExMatcher(basename);
}
var _routes2, _hmrRoutes, _matcher, _a3;
var DataRoutes = (_a3 = class {
  constructor(routes, matcher) {
    __privateAdd(this, _routes2);
    __privateAdd(this, _hmrRoutes);
    __privateAdd(this, _matcher);
    __privateSet(this, _routes2, routes);
    __privateSet(this, _matcher, matcher);
    __privateGet(this, _matcher).update(routes);
  }
  /** The stable route tree */
  get stableRoutes() {
    return __privateGet(this, _routes2);
  }
  /** The in-flight route tree if one is active, otherwise the stable tree */
  get activeRoutes() {
    return __privateGet(this, _hmrRoutes) ?? __privateGet(this, _routes2);
  }
  get hasHMRRoutes() {
  ...
  setRoutes(routes) {
    __privateSet(this, _routes2, routes);
    if (!__privateGet(this, _hmrRoutes)) __privateGet(this, _matcher).update(routes);
  }
  ...
  commitHmrRoutes() {
    if (__privateGet(this, _hmrRoutes)) {
      __privateSet(this, _routes2, __privateGet(this, _hmrRoutes));
      __privateSet(this, _hmrRoutes, void 0);
      __privateGet(this, _matcher).update(__privateGet(this, _routes2));
    }
  }
}, _routes2 = new WeakMap(), _hmrRoutes = new WeakMap(), _matcher = new WeakMap(), _a3);
function createRouter(init) {
  ...
  if (init.instrumentations) {
    ...
    mapRouteProperties = (route) => {
      return {
        ..._mapRouteProperties == null ? void 0 : _mapRouteProperties(route),
  ...
  async function navigate(to, opts) {
    ...
    let { path, submission, error } = normalizeNavigateOptions(false, normalizeTo(state.location, state.matches, basename, to, opts == null ? void 0 : opts.fromRouteId, opts == null ? void 0 : opts.relative), opts);
    let maskPath;
  ...
  async function startNavigation(historyAction, location, opts) {
    ...
    let matches = (opts == null ? void 0 : opts.initialHydration) && state.matches && state.matches.length > 0 && !initialMatchesIsFOW ? state.matches : dataRouteMatcher.match(location);
    let flushSync = (opts && opts.flushSync) === true;
    ...
    if (opts == null ? void 0 : opts.instrumentationNavigateMetaReceiver) {
  ...
  async function callDataStrategy(request, path, matches, scopedContext, fetcherKey) {
    ...
    if (!isMutationMethod(request.method)) for (let match of matches) {
      if (((_a5 = results[match.route.id]) == null ? void 0 : _a5.type) === "error") break;
...
function createStaticHandler(routes, opts) {
  ...
  let _mapRouteProperties = opts == null ? void 0 : opts.mapRouteProperties;
  let mapRouteProperties = _mapRouteProperties ? _mapRouteProperties : () => ({});
  let dataRouteMatcher = createDataRouteMatcher({ ...opts == null ? void 0 : opts.future }, basename);
        ...
        let response = await runServerMiddlewarePipeline({
          ...
          if (renderedStaticContext) {
            ...
            let staticContext = {
              ...
              loaderData: {},
              actionData: null,
              errors: { [skipLoaderErrorBubbling ? routeId : findNearestBoundary(matches, ((_a5 = matches.find((m) => m.route.id === routeId || m.route.loader)) == null ? void 0 : _a5.route.id) || routeId).route.id]: error },
  ...
  async function queryRoute(request, { routeId, requestContext, dataStrategy, generateMiddlewareResponse, normalizePath } = {}) {
    ...
    if (routeId && !match2) throw getInternalRouterError(403, {
      pathname: location.pathname,
      routeId
    });
    else if (!match2) throw getInternalRouterError(404, { pathname: location.pathname });
    if (generateMiddlewareResponse) {
      ...
      return await runServerMiddlewarePipeline({
        ...
        return await generateMiddlewareResponse(async (innerRequest) => {
          let processed = handleQueryResult(await queryImpl(innerRequest, location, matches, requestContext, dataStrategy || null, false, match2, null, false));
    ...
    return handleQueryResult(await queryImpl(request, location, matches, requestContext, dataStrategy || null, false, match2, null, false));
  ...
  async function loadRouteData(request, location, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch, filterMatchesToLoad, pendingActionResult) {
    ...
    if (isRouteRequest && !(routeMatch == null ? void 0 : routeMatch.route.loader) && !(routeMatch == null ? void 0 : routeMatch.route.lazy)) throw getInternalRouterError(400, {
      method: request.method,
      pathname: new URL(request.url).pathname,
    ...
    if (routeMatch) dsMatches = getTargetedDataStrategyMatches(mapRouteProperties, manifest, request, location, matches, routeMatch, [], requestContext);
      ...
      dsMatches = matches.map((match2, index) => {
        if (maxIdx != null && index > maxIdx) return getDataStrategyMatch(mapRouteProperties, manifest, request, location, pattern, match2, [], requestContext, false);
        return getDataStrategyMatch(mapRouteProperties, manifest, request, location, pattern, match2, [], requestContext, (match2.route.loader || match2.route.lazy) != null && (!filterMatchesToLoad || filterMatchesToLoad(match2)));
      });
    }
  ...
  async function callDataStrategy(request, location, matches, isRouteRequest, requestContext, dataStrategy) {
    ...
    await Promise.all(matches.map(async (match2) => {
      if (!(match2.route.id in results)) return;
      let result = results[match2.route.id];
      if (isRedirectDataStrategyResult(result)) {
        let response = result.result;
        throw normalizeRelativeRoutingRedirectResponse(response, request, match2.route.id, matches, basename);
      }
      if (isRouteRequest) {
...
function isSameRoute(newRoute, existingRoute) {
  ...
  return ((_a5 = newRoute.children) == null ? void 0 : _a5.every((aChild, i) => {
    var _a6;
    return (_a6 = existingRoute.children) == null ? void 0 : _a6.some((bChild) => isSameRoute(aChild, bChild));
  })) ?? false;
}
  ...
  async function errorHandler(error, routeId, nextResult) {
    ...
    if (nextResult) return Object.assign(nextResult.value, { [routeId]: {
      ...
      for (let match of matches.slice(0, maxBoundaryIdx + 1)) try {
        await ((_a5 = match._lazyPromises) == null ? void 0 : _a5.route);
      } catch {
...
function dataWithResponseInitToErrorResponse(data2) {
  var _a5, _b;
  return new ErrorResponseImpl(((_a5 = data2.init) == null ? void 0 : _a5.status) ?? 500, ((_b = data2.init) == null ? void 0 : _b.statusText) ?? "Internal Server Error", data2.data);
}
...
function getInstrumentationNavigateMeta(history, location, matches) {
  ...
  return {
    ...
    params: ((_a5 = matches == null ? void 0 : matches[0]) == null ? void 0 : _a5.params) ? { ...matches[0].params } : {}
  };
}
...
var DataRouterDataContext = React$12.createContext(null);
DataRouterDataContext.displayName = "DataRouterData";
var DataRouterNavigationContext = React$12.createContext(null);
...
var FetchersContext = React$12.createContext(null);
...
var IsDataRouteContext = React$12.createContext(false);
IsDataRouteContext.displayName = "IsDataRoute";
var RouteIdContext = React$12.createContext(void 0);
...
function useNavigate() {
  return React$13.useContext(IsDataRouteContext) ? useNavigateStable() : useNavigateUnstable();
}
...
function useParams() {
  var _a5;
  let { matches } = React$13.useContext(RouteContext);
  return ((_a5 = matches[matches.length - 1]) == null ? void 0 : _a5.params) ?? {};
}
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`);
  ...
  if (locationArg) {
    ...
    invariant(parentPathnameBase === "/" || ((_a5 = parsedLocationArg.pathname) == null ? void 0 : _a5.startsWith(parentPathnameBase)), `When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${parentPathnameBase}" but pathname "${parsedLocationArg.pathname}" was given in the \`location\` prop.`);
...
var _a4;
var RenderErrorBoundary = (_a4 = class extends React$13.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    let result = error !== void 0 ? React$13.createElement(RouteContext.Provider, { value: this.props.routeContext }, React$13.createElement(IsDataRouteContext.Provider, { value: this.props.routeContext.isDataRoute }, React$13.createElement(RouteIdContext.Provider, { value: (_a5 = this.props.routeContext.matches[this.props.routeContext.matches.length - 1]) == null ? void 0 : _a5.route.id }, React$13.createElement(RouteErrorContext.Provider, {
      value: error,
...
}, __publicField(_a4, "contextType", RSCRouterContext), _a4);
...
function RenderedRoute({ routeContext, match, children }) {
  ...
  return React$13.createElement(RouteContext.Provider, { value: routeContext }, React$13.createElement(IsDataRouteContext.Provider, { value: routeContext.isDataRoute }, React$13.createElement(RouteIdContext.Provider, { value: match.route.id }, children)));
}
function _renderMatches(matches, parentMatches = [], dataRouterOpts) {
  ...
  let onError = dataRouterState && onErrorHandler ? (error, errorInfo) => {
    ...
    onErrorHandler(error, {
      ...
      params: ((_b = (_a5 = dataRouterState.matches) == null ? void 0 : _a5[0]) == null ? void 0 : _b.params) ?? {},
...
function useDataRouterFetchers(hookName) {
  let fetchers = React$13.useContext(FetchersContext);
  invariant(fetchers, getDataRouterConsoleError(hookName));
  return fetchers;
}
function useDataRouterData(hookName) {
  let data2 = React$13.useContext(DataRouterDataContext);
  invariant(data2, getDataRouterConsoleError(hookName));
  return data2;
}
function useDataRouterNavigation(hookName) {
  let navigation = React$13.useContext(DataRouterNavigationContext);
  invariant(navigation, getDataRouterConsoleError(hookName));
  return navigation;
}
function useCurrentRouteId(hookName) {
  let routeId = React$13.useContext(RouteIdContext);
...
function useLoaderData() {
  let data2 = useDataRouterData("useLoaderData");
  let routeId = useCurrentRouteId("useLoaderData");
  return data2.loaderData[routeId];
}
function useRouteLoaderData(routeId) {
  return useDataRouterData("useRouteLoaderData").loaderData[routeId];
}
function useActionData() {
  let data2 = useDataRouterData("useActionData");
  let routeId = useCurrentRouteId("useActionData");
  return data2.actionData ? data2.actionData[routeId] : void 0;
}
function useRouteError() {
  var _a5;
  let error = React$13.useContext(RouteErrorContext);
  let data2 = useDataRouterData("useRouteError");
  let routeId = useCurrentRouteId("useRouteError");
  if (error !== void 0) return error;
  return (_a5 = data2.errors) == null ? void 0 : _a5[routeId];
}
function useAsyncValue() {
  var _a5;
  return (_a5 = React$13.useContext(AwaitContext)) == null ? void 0 : _a5._data;
}
function useAsyncError() {
  var _a5;
  return (_a5 = React$13.useContext(AwaitContext)) == null ? void 0 : _a5._error;
}
var blockerId = 0;
...
function useRoute(...args) {
  ...
  const data2 = useDataRouterData("useRoute");
  const route = state.matches.find(({ route: route2 }) => route2.id === id);
  if (route === void 0) return void 0;
  return {
    handle: route.route.handle,
    loaderData: data2.loaderData[id],
    actionData: (_a5 = data2.actionData) == null ? void 0 : _a5[id]
  };
}
...
function useRouterState() {
  ...
  let active = React$13.useMemo(() => {
    ...
    return {
      ...
      params: ((_a5 = matches[matches.length - 1]) == null ? void 0 : _a5.params) ?? {},
  ...
  let pending = React$13.useMemo(() => {
    ...
    let shared = {
      ...
      params: ((_a5 = navigation.matches[navigation.matches.length - 1]) == null ? void 0 : _a5.params) ?? {},
...
function RouterProvider({ router, flushSync: reactDomFlushSyncImpl, onError, useTransitions }) {
  ...
  let setState = React$14.useCallback((newState, { deletedFetchers, newErrors, flushSync, viewTransitionOpts }) => {
    if (newErrors && onError) Object.values(newErrors).forEach((error) => {
      var _a5;
      return onError(error, {
        location: newState.location,
        params: ((_a5 = newState.matches[0]) == null ? void 0 : _a5.params) ?? {},
  ...
  let dataRouterState = React$14.useMemo(() => ({
  ...
  let dataRouterNavigation = React$14.useMemo(() => ({
    navigation: state.navigation,
    revalidation: state.revalidation
  }), [state.navigation, state.revalidation]);
  let dataRouterData = React$14.useMemo(() => ({
  ...
  let fetchersContext = React$14.useMemo(() => ({
    fetchers: state.fetchers,
    fetcherData: fetcherData.current
  }), [state.fetchers]);
  return React$14.createElement(React$14.Fragment, null, React$14.createElement(DataRouterContext.Provider, { value: dataRouterContext }, React$14.createElement(DataRouterStateContext.Provider, { value: dataRouterState }, React$14.createElement(DataRouterNavigationContext.Provider, { value: dataRouterNavigation }, React$14.createElement(DataRouterDataContext.Provider, { value: dataRouterData }, React$14.createElement(FetchersContext.Provider, { value: fetchersContext }, React$14.createElement(ViewTransitionContext.Provider, { value: vtContext }, React$14.createElement(Router, {
    basename,
    location: state.location,
...
function DataRoutes2({ routes, manifest, state, isStatic, onError }) {
...
function Await({ children, errorElement, resolve }) {
  ...
  let onError = React$14.useCallback((error, errorInfo) => {
    ...
    if (dataRouterContext && dataRouterContext.onError && dataRouterStateContext) dataRouterContext.onError(error, {
      ...
      params: ((_a5 = dataRouterStateContext.matches[0]) == null ? void 0 : _a5.params) || {},
    ...
    if ("routes" in fetchedData) {
      for (let match of matches) if (match.route.id in fetchedData.routes) {
        ...
        if ("error" in routeResult) {
          ...
          if (((_a5 = results[match.route.id]) == null ? void 0 : _a5.result) == null) results[match.route.id] = {
            type: "error",
...
function getNewMatchesForLinks(page, nextMatches, currentMatches, manifest, location, mode) {
  ...
  let matchPathChanged = (match, index) => {
    var _a5;
    return currentMatches[index].pathname !== match.pathname || ((_a5 = currentMatches[index].route.path) == null ? void 0 : _a5.endsWith("*")) && currentMatches[index].params["*"] !== match.params["*"];
  };
...
function useFogOFWarDiscovery(router, manifest, routeModules, ssr, routeDiscovery, isSpaMode) {
  React$18.useEffect(() => {
    var _a5, _b;
    if (!isFogOfWarEnabled(routeDiscovery, ssr) || ((_b = (_a5 = window.navigator) == null ? void 0 : _a5.connection) == null ? void 0 : _b.saveData) === true) return;
...
async function handleClientVersionMismatch(needsReload, version, errorReloadPath) {
  ...
  let failReload = () => {
    ...
    rejectReload(new Error("Unable to discover routes due to manifest version mismatch."));
  };
...
function PrefetchPageLinks({ page, ...linkProps }) {
  ...
  let matches = React$19.useMemo(() => router.match(page), [
    router,
    router.routes,
    page
  ]);
...
function PrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
  ...
  let dataHrefs = React$19.useMemo(() => {
    ...
    nextMatches.forEach((m) => {
      ...
      if (!newMatchesForData.some((m2) => m2.route.id === m.route.id) && m.route.id in loaderData && ((_a5 = routeModules[m.route.id]) == null ? void 0 : _a5.shouldRevalidate)) foundOptOutRoute = true;
...
function Meta() {
  ...
  for (let i = 0; i < _matches.length; i++) {
    ...
    matches[i] = match;
    if (routeModule == null ? void 0 : routeModule.meta) routeMeta = typeof routeModule.meta === "function" ? routeModule.meta({
      loaderData: data2,
      params,
      location,
      matches,
...
function BoundaryShell({ title, renderScripts, isOutsideRemixApp, children }) {
  ...
  if (((_a5 = routeModules.root) == null ? void 0 : _a5.Layout) && !isOutsideRemixApp) return children;
...
var NavLink = React$111.forwardRef(function NavLinkWithRef({ "aria-current": ariaCurrentProp = "page", caseSensitive = false, className: classNameProp = "", end = false, style: styleProp, to, viewTransition, children, ...rest }, ref) {
  ...
  let location = useLocation();
  let routerNavigation = React$111.useContext(DataRouterNavigationContext);
  ...
  let nextLocationPathname = (routerNavigation == null ? void 0 : routerNavigation.navigation.location) ? routerNavigation.navigation.location.pathname : null;
  if (!caseSensitive) {
...
function ScrollRestoration({ getKey, storageKey, ...props }) {
  ...
  if (props.nonce == null && (remixContext == null ? void 0 : remixContext.nonce)) props.nonce = remixContext.nonce;
...
function useFetcher({ key } = {}) {
  ...
  let data2 = fetchersContext.fetcherData.get(fetcherKey);
...
function useFetchers() {
  ...
  return React$111.useMemo(() => Array.from(fetchers.entries()).map(([key, fetcher]) => ({
    ...fetcher,
    key
  })), [fetchers]);
}
...
function useScrollRestoration({ getKey, storageKey } = {}) {
  ...
  if (typeof document !== "undefined") {
    ...
    React$111.useLayoutEffect(() => {
      let disableScrollRestoration = router == null ? void 0 : router.enableScrollRestoration(savedScrollPositions, () => window.scrollY, getKey ? (location2, matches2) => getScrollRestorationKey(location2, matches2, basename, getKey) : void 0);
...
function StaticRouterProvider({ context, router, hydrate: hydrate2 = true, nonce }) {
  ...
  return React$112.createElement(React$112.Fragment, null, React$112.createElement(DataRouterContext.Provider, { value: dataRouterContext }, React$112.createElement(DataRouterStateContext.Provider, { value: dataRouterState }, React$112.createElement(DataRouterNavigationContext.Provider, { value: dataRouterNavigation }, React$112.createElement(DataRouterDataContext.Provider, { value: dataRouterData }, React$112.createElement(FetchersContext.Provider, { value: fetchersContext }, React$112.createElement(ViewTransitionContext.Provider, { value: { isTransitioning: false } }, React$112.createElement(Router, {
...
function createStaticRouter(routes, context, opts = {}) {
  ...
  let future = { ...opts == null ? void 0 : opts.future };
  let matchRoutes2 = context._match;
  ...
  return {
    ...
    match(locationArg) {
      var _a5;
      return ((_a5 = matchRoutes2(locationArg)) == null ? void 0 : _a5.map(mapRouteMatch)) ?? null;
    },
    initialize() {
...
function parse(str, options) {
  ...
  const allowMultiple = (options == null ? void 0 : options.allowMultiple) || false;
  let index = 0;
  do {
    ...
    if ((options == null ? void 0 : options.filter) && !options.filter(key)) {
      index = endIdx + 1;
      continue;
    }
...
function serialize(_a0, _a1, _a22) {
  ...
  const options = isObj ? _a1 : _a22;
  const stringify3 = (options == null ? void 0 : options.stringify) || JSON.stringify;
...
function derive(build, mode) {
  ...
  let requestHandlerInstrumentations = (_a5 = build.entry.module.instrumentations) == null ? void 0 : _a5.map((i) => i.handler).filter(Boolean);
  let requestHandler = async (request, initialContext) => {
    ...
    let handleError = (error) => {
      var _a7, _b2;
      if (mode === "development") (_b2 = (_a7 = getDevServerHooks()) == null ? void 0 : _a7.processRequestError) == null ? void 0 : _b2.call(_a7, error);
      errorHandler(error, {
        context: loadContext,
        params,
        request
    ...
    if (requestHandlerInstrumentations == null ? void 0 : requestHandlerInstrumentations.length) loadContext.set(instrumentationResultMetaContext, {
      url: createDataFunctionUrl(request, normalizedPath),
      pattern: matches ? getRoutePattern(matches) : "",
      params: ((_a6 = matches == null ? void 0 : matches[0]) == null ? void 0 : _a6.params) ? { ...matches[0].params } : {}
    });
    let response;
    if (requestUrl.pathname.endsWith(".data")) {
      ...
      else if (mode === "development" && ((_b = getDevServerHooks()) == null ? void 0 : _b.getCriticalCss)) criticalCss = await ((_d = (_c = getDevServerHooks()) == null ? void 0 : _c.getCriticalCss) == null ? void 0 : _d.call(_c, pathname));
  ...
  if (requestHandlerInstrumentations == null ? void 0 : requestHandlerInstrumentations.length) requestHandler = instrumentHandler(requestHandler, requestHandlerInstrumentations);
  return {
    serverMode,
    staticHandler,
    errorHandler,
...
async function routeRSCServerRequest({ request, serverResponse, createFromReadableStream, renderHTML, hydrate: hydrate2 = true, nonce }) {
  ...
  try {
    ...
    if (!(serverResponseB == null ? void 0 : serverResponseB.body)) throw new Error("Failed to clone server response");
...
react-router/dist/development/lib/router/url.js:
  (**
   * react-router v8.4.0
   *
...
react-router/dist/development/lib/router/utils.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/router/instrumentation.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/router/matcher.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/router/matcher-route-pattern.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/router/matcher-route-pattern.preload.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/router/navigation.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/context.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/errors.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/hooks.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/warnings.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/components.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/dom.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/invariant.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/markup.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/vendor/turbo-stream-v2/utils.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/vendor/turbo-stream-v2/flatten.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/vendor/turbo-stream-v2/unflatten.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/vendor/turbo-stream-v2/turbo-stream.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/data.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/single-fetch.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/routeModules.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/links.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/fallback.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/routes.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/fog-of-war.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/components.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/errorBoundaries.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/lib.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/server.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/server.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/routes-test-stub.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/crypto.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/cookies.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/mode.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/dev.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/entry.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/errors.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/invariant.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/routeMatching.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/data.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/routes.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/serverHandoff.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/headers.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/actions.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/urls.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/single-fetch.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/server.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/sessions.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/sessions/cookieStorage.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/server-runtime/sessions/memoryStorage.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/href.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/rsc/errorBoundaries.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/rsc/html-stream/server.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/rsc/route-modules.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/rsc/server.ssr.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
...
react-router/dist/development/lib/dom/ssr/hydration.js:
  (**
   * react-router v8.4.0
   *
   * Copyright (c) Remix Software Inc.
