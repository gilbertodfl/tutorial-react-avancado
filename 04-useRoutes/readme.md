...
# OBJETIVO: Usando useRoutes

O mercado usa mais esse padrão de useRoutes que é mais fácil e declarativo.
Prefira usar o useRoutes.

O useRoute vai usar um objeto que contém várias coisas entre elas:
  - path ( caminho )
  - element arquivo jsx
  - layout padrão

Tudo insto em um array. 

Aqui fizemos uma copia do arquivo AppRoutes.jsx com o nome de JsRoutes.jsx
Observe que no main trocamos também: 

     ```<JsRoutes />```

## como é mais fácil com o useRoute
```
